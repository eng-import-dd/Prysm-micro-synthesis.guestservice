...
{
    public class EmailAddressValidator : StringValidator
    {
        public EmailAddressValidator() : base("GuestEmail")
        {
            RuleFor(request => EmailValidator.IsValid(request))
                .Equal(true).WithMessage("The Email address is invalid");
        }
    }

    internal class EmailValidator : StringValidator
    {
        ...
        public EmailValidator() : base("ProjectAccessCode")
        {
