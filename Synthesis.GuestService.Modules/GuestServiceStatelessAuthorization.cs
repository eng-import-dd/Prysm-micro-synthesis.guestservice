...
namespace Synthesis.GuestService
{
    ...
    {
        /// <inheritdoc />
        public GuestServiceStatelessAuthorization(ISynthesisMonolithicCloudDao synthesisMonolithicCloudDao, ILoggingService logger) : base(synthesisMonolithicCloudDao, logger)
        {
        }
